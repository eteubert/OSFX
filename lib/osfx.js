          ...
          case "osfx-validate":
            if ( result == "" ) {
              $("#osfx_validation_table").hide();
               $("#osfx_validation_status").html("<span class='isValid' title='Your Markup is valid'>Valid</span>");
            } else {
              if ( result.length == 1 ) {
                error_status = "Your Shownote markup contains " + result.length + " error!";
              } else {
                error_status = "Your Shownote markup contains " + result.length + " errors!";
              }
              $("#osfx_validation_status").html("<span class='isInValid' title='" + error_status + "'>" + error_status + "</span>");
